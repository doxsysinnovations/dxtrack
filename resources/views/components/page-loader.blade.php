<div id="page-loader" data-role="page-loader-container"
    class="fixed z-50 flex flex-wrap items-center justify-center w-screen h-screen overflow-hidden text-blue-950 bg-gray-500 bg-opacity-50 backdrop-blur-sm"
    style="display: none">
