...
<div data-role="avatar"
    {{ $attributes->merge(['class' => 'relative aspect-square flex flex-wrap items-center justify-center gap-2 overflow-hidden text-lg font-semibold text-center text-white bg-blue-950 rounded-full cursor-default select-none border-2 border-gray-200']) }}>
    ...
    @if ($asset != null)
        <div
            class="flex items-center w-full h-full overflow-hidden bg-blue-950 rounded-full cursor-default select-none justify-center-center">
